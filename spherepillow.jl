...
function pillow(h;R=1)
    S(u,v) = R .* SA[cos(u),cos(v),R*sin(u)*sin(v)]
    du = π/round(π*R/h) # azimuth step size
    mapreduce(vcat,0:du:π) do u
        dv = 2π/round(2π*R*sin(u)/h) # polar step size at this azimuth
        param_props.(S,u,-π:dv:π,du,dv)
    end |> Table
end
...
manifest_format = "2.0"
project_hash = "bb967b2f936c10d651383be45706ec63d0805cad"
